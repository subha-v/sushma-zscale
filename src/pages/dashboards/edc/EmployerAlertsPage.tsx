...
const MOCK_ALERTS: EmployerAlert[] = [
  ...
  { id: "ea-4", company_name: "Bell Textron", signal_type: "new_facility", signal_strength: "critical", title: "FLRAA V-280 Valor production begins", description: "V-280 Valor FLRAA program entering low-rate initial production. New DFW engineering center operational. 500+ positions opening across manufacturing, software, and flight test. Largest defense hiring event in Arlington history.", source: "DoD contract award — February 2025", detected_at: "2025-03-15" },
  { id: "ea-5", company_name: "D.R. Horton", signal_type: "hiring_surge", signal_strength: "moderate", title: "Q1 2025 expansion — 45 new positions", description: "Homebuilder expanding project management, sales, and sustainability teams. DFW housing starts up 12% in Q1 2025. New sustainable construction division creating demand for green building expertise.", source: "Q1 2025 earnings call + job postings", detected_at: "2025-03-20" },
  { id: "ea-6", company_name: "Arlington ISD", signal_type: "contraction", signal_strength: "moderate", title: "Budget reduction for 2025-2026", description: "District approved 4.2% budget reduction for 2025-2026. Eliminating 85 non-teaching positions through attrition. Core teaching and special education positions protected. STEM program expansion delayed.", source: "School board vote — March 2025", detected_at: "2025-03-17" },
]
