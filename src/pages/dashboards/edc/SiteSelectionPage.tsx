...
const MOCK_PACKAGES: SitePackage[] = [
  ...
  { id: "ssp-4", company_name: "DataFlow Analytics", industry: "Data & AI", target_roles: ["ML Engineer", "Data Engineer", "Product Manager", "LLM Specialist"], headcount_needed: 120, status: "complete", key_highlights: ["UTA Data Science program growing 15% annually in enrollment", "AI/ML specialization track launched Spring 2025", "Strong emerging skills alignment (GenAI, LLMs, MLOps, RAG)", "DFW ranked #4 in AI job growth nationally in 2024"] },
]
        ...
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-body text-neutral-400">
              Generate comprehensive talent and labor market packages for companies considering Arlington/DFW.
              Each package includes talent supply data, employer landscape, cost of living, and training pipeline information.
            </p>
          </div>
          <button
            onClick={() => askAgent?.('Generate a site selection package for a technology company considering Arlington')}
