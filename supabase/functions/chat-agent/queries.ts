...
const MOCK_EMPLOYERS = [
  ...
  // Grapevine employers
  { id: "grp-emp-1", company_name: "DFW International Airport", industry: "Aviation & Logistics", naics_code: "488119", employee_count: 1500, employee_range: "1000-4999", city: "Grapevine", state: "TX", zip_code: "76051", is_fortune_500: false, is_headquartered_locally: true, website_url: "https://www.dfwairport.com", description: "4th busiest US airport, major economic engine for DFW", year_established: 1974, hires_uta_grads: false },
  { id: "grp-emp-2", company_name: "Kubota North America HQ", industry: "Manufacturing & Equipment", naics_code: "333111", employee_count: 500, employee_range: "100-499", city: "Grapevine", state: "TX", zip_code: "76051", is_fortune_500: false, is_headquartered_locally: true, website_url: "https://www.kubotausa.com", description: "$51M headquarters campus, relocated from CA in 2017", year_established: 2017, hires_uta_grads: false },
  { id: "grp-emp-3", company_name: "Paycom", industry: "Software & HR Technology", naics_code: "511210", employee_count: 1000, employee_range: "500-999", city: "Grapevine", state: "TX", zip_code: "76051", is_fortune_500: false, is_headquartered_locally: false, website_url: "https://www.paycom.com", description: "150,000 sq ft operations center, 2nd largest Paycom office", year_established: 2018, hires_uta_grads: false },
  { id: "grp-emp-4", company_name: "Gaylord Texan Resort", industry: "Hospitality & Tourism", naics_code: "721110", employee_count: 2000, employee_range: "1000-4999", city: "Grapevine", state: "TX", zip_code: "76051", is_fortune_500: false, is_headquartered_locally: false, website_url: "https://www.marriott.com/gaylord-texan", description: "1,814 rooms, 486,000 sq ft meeting space, 2nd-largest non-gaming convention hotel in US", year_established: 2004, hires_uta_grads: false },
];
...
const MOCK_JOB_OPENINGS = [
  ...
  // Grapevine jobs
  { id: "grp-job-1", employer_id: "grp-emp-1", job_title: "Airport Operations Coordinator", department: "Operations", salary_min: 52000, salary_max: 68000, salary_type: "annual", education_required: "bachelor", experience_years_min: 0, required_skills: ["Operations Management", "FAA Regulations", "Emergency Response"], preferred_skills: ["Aviation Management", "TSA Protocols"], is_entry_level: true, is_internship: false, job_type: "full-time", remote_option: "on-site", openings_count: 8, posted_date: "2026-03-15", is_active: true },
  { id: "grp-job-2", employer_id: "grp-emp-3", job_title: "Software Developer", department: "Engineering", salary_min: 78000, salary_max: 105000, salary_type: "annual", education_required: "bachelor", experience_years_min: 0, required_skills: ["Java", "SQL", "REST APIs", "Agile"], preferred_skills: ["React", "AWS", "TypeScript"], is_entry_level: true, is_internship: false, job_type: "full-time", remote_option: "hybrid", openings_count: 6, posted_date: "2026-03-18", is_active: true },
  { id: "grp-job-3", employer_id: "grp-emp-4", job_title: "Hospitality Manager", department: "Hotel Operations", salary_min: 55000, salary_max: 72000, salary_type: "annual", education_required: "bachelor", experience_years_min: 2, required_skills: ["Hotel Operations", "Team Management", "Guest Services"], preferred_skills: ["Marriott Brand Standards", "Revenue Management"], is_entry_level: false, is_internship: false, job_type: "full-time", remote_option: "on-site", openings_count: 4, posted_date: "2026-03-20", is_active: true },
];
...
const MOCK_DEVELOPMENT = [
  ...
  { id: "grp-dev-1", project_name: "Kubota North America HQ Campus", project_type: "commercial", developer: "Kubota Tractor Corporation", investment_amount: 51000000, estimated_jobs: 500, status: "operational", location_description: "Kubota NA HQ, Grapevine TX", start_year: 2015, completion_year: 2017, description: "$51M, 193,000 sq ft corporate HQ. Relocated from CA with Gov. Abbott.", industries_impacted: ["Manufacturing & Equipment", "Corporate HQ"] },
  { id: "grp-dev-2", project_name: "DFW Terminal F Modernization", project_type: "infrastructure", developer: "DFW Airport Board", investment_amount: 4000000000, estimated_jobs: 5000, status: "under_construction", location_description: "DFW International Airport, Grapevine TX", start_year: 2023, completion_year: 2030, description: "$4B Terminal F expansion. Phase 1 opening 2027. Largest airport capital program in the US.", industries_impacted: ["Aviation & Logistics", "Construction", "Technology"] },
];
...
const MOCK_INDUSTRIES = [
  ...
  { id: "grp-ind-1", industry_name: "Hospitality & Tourism (Grapevine)", naics_sector: "721", employment_count: 8500, avg_annual_wage: 42000, growth_rate: 5.8, location_quotient: 2.5, top_occupations: ["Hotel Managers", "Event Coordinators", "Food Service Managers"], key_employers: ["Gaylord Texan", "Great Wolf Lodge", "Hilton DFW Lakes"], description: "Grapevine is a premier hospitality destination anchored by the Gaylord Texan and DFW Airport.", data_year: 2024, data_source: "TWC / BLS" },
  { id: "grp-ind-2", industry_name: "Aviation & Logistics (Grapevine)", naics_sector: "488", employment_count: 4200, avg_annual_wage: 65000, growth_rate: 4.1, location_quotient: 3.2, top_occupations: ["Airport Operations", "Air Traffic Control", "Cargo Handlers"], key_employers: ["DFW International Airport", "American Airlines", "FedEx"], description: "DFW Airport (4th busiest US) drives significant aviation employment.", data_year: 2024, data_source: "TWC / BLS" },
  { id: "grp-ind-3", industry_name: "Technology & Software (Grapevine)", naics_sector: "5112", employment_count: 2800, avg_annual_wage: 95000, growth_rate: 7.5, location_quotient: 0.9, top_occupations: ["Software Developers", "Systems Analysts", "Data Engineers"], key_employers: ["Paycom", "GameStop Digital"], description: "Growing tech presence anchored by Paycom operations center.", data_year: 2024, data_source: "TWC / BLS" },
];
...
const MOCK_LABOR_STATS = [
  { id: "arl-stat-1", metric_name: "Total Nonfarm Employment", metric_category: "employment", metric_value: 1212800, metric_unit: "count", geography: "Fort Worth-Arlington MD", time_period: "March 2026", data_source: "BLS CES", notes: "" },
  ...
  // Grapevine labor stats
  { id: "grp-stat-1", metric_name: "Total Population", metric_category: "demographics", metric_value: 51320, metric_unit: "count", geography: "Grapevine, TX", time_period: "2024", data_source: "Census ACS", notes: "" },
  { id: "grp-stat-2", metric_name: "Median Household Income", metric_category: "wages", metric_value: 112000, metric_unit: "dollars", geography: "Grapevine, TX", time_period: "2024", data_source: "Census ACS", notes: "Significantly above DFW average" },
  { id: "grp-stat-3", metric_name: "Unemployment Rate", metric_category: "employment", metric_value: 3.4, metric_unit: "percent", geography: "Grapevine, TX", time_period: "Q4 2024", data_source: "BLS LAUS", notes: "Tarrant County rate" },
];
...
const MOCK_SITE_SELECTION_PACKAGES = [
  ...
  // Grapevine site selection packages
  { id: "ssp-5", company_name: "Corporate HQ Prospect - Grapevine", industry: "Corporate / Technology", target_roles: ["Executive", "Software Engineer", "Operations Manager"], headcount_needed: 200, status: "complete", key_highlights: ["Adjacent to DFW Airport (4th busiest US)", "Median household income $112K", "$2B+ Grapevine EDC track record", "Kubota chose Grapevine for NA HQ ($51M)", "TEXRail commuter rail access"] },
  { id: "ssp-6", company_name: "Hospitality & Tourism Expansion - Grapevine", industry: "Hospitality & Tourism", target_roles: ["Hotel Manager", "Event Coordinator", "Guest Services"], headcount_needed: 150, status: "complete", key_highlights: ["8,500+ hospitality workers in Grapevine", "Gaylord Texan + Great Wolf Lodge anchors", "500K+ annual visitors", "Historic Main Street + Grapevine Mills"] },
];

const MOCK_EMPLOYER_ALERTS = [
  { id: "ea-1", company_name: "Texas Health Resources", signal_type: "hiring_surge", signal_strength: "strong", title: "30% increase in nursing postings", description: "Job postings for RN positions increased 30% month-over-month across all DFW facilities.", source: "Job posting analysis — March 2026", is_acknowledged: false, detected_at: "2026-03-20" },
  { id: "ea-2", company_name: "General Motors Arlington Assembly", signal_type: "expansion", signal_strength: "strong", title: "EV transition creating new roles", description: "GM announcing $500M+ investment in electric vehicle production capabilities. Expected 200+ new technical positions.", source: "Press release + SEC filing — Q1 2026", is_acknowledged: false, detected_at: "2026-03-17" },
  { id: "ea-3", company_name: "Lockheed Martin Aeronautics", signal_type: "hiring_surge", signal_strength: "moderate", title: "F-35 production ramp hiring", description: "Sustained hiring for software engineers and systems engineers. 80+ positions expected in next 6 months.", source: "Defense contract + job posting analysis — March 2026", is_acknowledged: false, detected_at: "2026-03-15" },
  { id: "ea-4", company_name: "Bell Textron", signal_type: "new_facility", signal_strength: "strong", title: "V-280 Valor FLRAA production facility", description: "Bell preparing new production line for V-280 Valor. DFW engineering expansion expected.", source: "DoD contract award — February 2026", is_acknowledged: false, detected_at: "2026-03-12" },
  { id: "ea-5", company_name: "D.R. Horton", signal_type: "hiring_surge", signal_strength: "moderate", title: "Expanding DFW operations", description: "Homebuilder expanding project management and sales teams. 30+ positions posted.", source: "Q1 2026 earnings call + job postings", is_acknowledged: false, detected_at: "2026-03-19" },
  { id: "ea-6", company_name: "Arlington ISD", signal_type: "contraction", signal_strength: "weak", title: "Budget tightening signals", description: "District facing potential budget constraints. May slow non-essential hiring.", source: "School board vote — March 2026", is_acknowledged: false, detected_at: "2026-03-08" },
  // Grapevine employer alerts
  { id: "ea-7", company_name: "Kubota North America HQ", signal_type: "expansion", signal_strength: "strong", title: "R&D center and dealer training expansion", description: "Kubota expanding Grapevine campus with new R&D center and dealer training facility. 100+ new positions in engineering and training.", source: "Corporate press release + Grapevine EDC — March 2026", is_acknowledged: false, detected_at: "2026-03-22" },
  { id: "ea-8", company_name: "Paycom", signal_type: "hiring_surge", signal_strength: "strong", title: "40+ new positions — CEO cites DFW talent", description: "Paycom Grapevine posting 40+ positions across software engineering, client services, and data analytics.", source: "Job posting analysis + earnings call — Q1 2026", is_acknowledged: false, detected_at: "2026-03-20" },
  { id: "ea-9", company_name: "DFW International Airport", signal_type: "new_facility", signal_strength: "critical", title: "$4B Terminal F — Phase 1 opening 2027", description: "DFW Airport Board approved $4B Terminal F modernization. 5,000+ construction and 500+ permanent ops jobs.", source: "DFW Airport Board + Dallas Innovates — March 2026", is_acknowledged: false, detected_at: "2026-03-18" },
];
...
const MOCK_REGIONAL_COMPARISON = [
  ...
  // Grapevine + Southlake + Frisco regional comparisons
  { region: "Grapevine, TX", metric: "Total Employment", value: 29218, unit: "count" },
  { region: "Grapevine, TX", metric: "Avg Weekly Wages", value: 1450, unit: "dollars" },
  { region: "Grapevine, TX", metric: "Unemployment Rate", value: 3.4, unit: "percent" },
  { region: "Southlake, TX", metric: "Total Employment", value: 15000, unit: "count" },
  { region: "Southlake, TX", metric: "Avg Weekly Wages", value: 1800, unit: "dollars" },
  { region: "Southlake, TX", metric: "Unemployment Rate", value: 2.8, unit: "percent" },
  { region: "Frisco, TX", metric: "Total Employment", value: 120000, unit: "count" },
  { region: "Frisco, TX", metric: "Avg Weekly Wages", value: 1550, unit: "dollars" },
  { region: "Frisco, TX", metric: "Unemployment Rate", value: 3.2, unit: "percent" },
];
